...
RECALLING_HAND_SCROLL = {
    ...
    'lines': [
        ...
        ('blank',),
        ('cmd',    'Ctrl-r "', 'insert the unnamed register'),
        ('cmd',    'Ctrl-r 0', 'paste your last yank'),
        ('segs',   [('Ctrl-r ', True), ('{reg}', False)], 'paste any named register'),
        ('cmd',    'Ctrl-r Ctrl-w', 'insert the word under cursor'),
        ('blank',),
...
QUICK_ERASE_SCROLL = {
    ...
    'lines': [
        ...
        ('cmd',    'Ctrl-o', 'one Normal step, then back to typing'),
        ('blank',),
...
SEARCH_CRAFT_SCROLL = {
    ...
    'lines': [
        ...
        ('cmd',    'Ctrl-r Ctrl-w', "pull the cursor's word into /"),
        ('blank',),
...
WANDERERS_THREAD_SCROLL = {
    ...
    'lines': [
        ...
        ('blank',),
        ('cmd',    'Ctrl-o', 'thread back to where you leapt from'),
