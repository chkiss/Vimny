...
LEVELS = [
    ...
    {'display': '20',   'slug': 'quartermaster',         'name': 'The Quartermaster',          'commands': 'y yy P', 'teaches': ['y', 'P']},
    ...
    {'display': '23.5', 'slug': 'whole_line_annex',      'name': 'The Change Annex',           'commands': 'c{m}  cc  s  S  C', 'teaches': ['c', 's', 'S', 'C']},
