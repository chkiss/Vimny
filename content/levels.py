...
LEVELS = [
    ...
    {'display': '18',   'slug': 'operators_vault',       'name': "The Operator's Vault",       'commands': 'd{m}  dd  D', 'teaches': ['d']},
    {'display': '19',   'slug': 'cipher_cell',           'name': 'The Cipher Cell',            'commands': 's', 'teaches': ['s']},
    {'display': '20',   'slug': 'quartermaster',         'name': 'The Quartermaster',          'commands': 'y yy P', 'teaches': ['y', 'P', 'register']},
    {'display': '21',   'slug': 'undo_sanctum',          'name': 'The Undo Sanctum',           'commands': 'u  ⌃R', 'teaches': ['redo']},
    ...
    {'display': '23.5', 'slug': 'whole_line_annex',      'name': 'The Change Annex',           'commands': 'c{m}  cc  C  S', 'teaches': ['c', 'S']},
