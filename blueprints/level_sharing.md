...
`_serialize_room` (`engine/editor.py:273`) captures cells, char_runs, entity
...
|---|---|
| `vocab_plain`, `vocab_mixed` | `_load_vocab_tables()` (`generation/dungeon_gen.py:2502`) — dicts keyed by word length |
| `proverbs` | `content/proverbs.py` — `PLAIN` |
| `misquotes` | `content/proverbs.py` — `MISQUOTES`, `misquotes_by_cure_len()` |
