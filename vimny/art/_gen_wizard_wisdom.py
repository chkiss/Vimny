...
"""Source of truth for the Wizard Wisdom corpus — generates vimny/art/wizard_wisdom.txt.

Edit the POEMS list here, then run `python3 vimny/art/_gen_wizard_wisdom.py`.
...
`select_next_lesson_quote(completed_slug)` (vimny/render/title.py) finds the next
...
asserts the width. Keep introduces_slug in sync with vimny/content/levels.py.
"""
...
def main() -> None:
    ...
    header = (
        ...
        '# GENERATED by vimny/art/_gen_wizard_wisdom.py — do not edit by hand.\n'
        '#\n'
