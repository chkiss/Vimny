...
canonical sources — `vimny/content/levels.py` (the curriculum) and
`vimny/render/vim_commands.md` (the command reference).

Run after any curriculum or command change:

    python3 vimny/content/_gen_curriculum_table.py
...
Tables produced:
  ...
  - README.md Commands     — command reference from vimny/render/vim_commands.md
"""
...
_ROOT     = Path(__file__).parent.parent.parent   # the repo, not the package
_README   = _ROOT / 'README.md'
_VIM_CMDS = _ROOT / 'vimny' / 'render' / 'vim_commands.md'
