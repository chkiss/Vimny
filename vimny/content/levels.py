...
LEVELS = [
    ...
    # `u` is always-on; <C-r> comes from the redo relic scroll (vimny/content/scrolls.py).
    ...
    {'display': '44',   'slug': 'g_sanctum',             'name': 'The Last Reach',             'commands': 'g_ g* gi gp', 'teaches': ['g_family']},
    ...
    # ── The Registry — a post-adoption bonus wing (docs/blueprints/registry_wing.md).
